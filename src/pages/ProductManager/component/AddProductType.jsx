      ...
      <div className="row">
        ...
        <form className='ad-activity' encType='multipart/form-data'>
          ...
          {/* <div className="form-group">
            ...
            <div class="form-group">
              <label>Giá Bán <span className='star'>*</span></label>
              <input type="text" name="name" class="form-control" placeholder="0VND" value=""/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>Số Lượng Tồn <span className='star'>*</span></label>
              <input type="text" name="name" class="form-control" placeholder="Nhập số lượng tồn..." value=""/>
            </div>
            <div class="form-group">
              <label>Tên Sản Phẩm <span className='star'>*</span></label>
              <input type="" name="name" class="form-control" placeholder="Nhập tên sản phẩm" value=""/>
            </div>
          
          <div>
            <img src="https://bossluxury.vn/uploads/nhan-biet-dong-ho-patek-philippe-that-va-gia-46.jpg" alt="" className='h-150'/>
          </div>
          <div className='photo'>
